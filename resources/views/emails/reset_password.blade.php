                    ...
                    <tr>
                      <td style="padding-left:24px; padding-right:24px; padding-bottom:24px;">
                        ...
                        <div style="text-align:center; margin-top:24px; margin-bottom:24px;">
                          <a href="{{ $resetTokenLink }}" class="cta-button" style="display:inline-block; border-radius:2px; background-color:#17c89d; line-height:36px; color:#ffffff; text-decoration:none; padding-left:24px; padding-right:24px;">Reset my password </a>
                        </div>

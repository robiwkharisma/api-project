                  ...
                  <table class="body" style="border-spacing:0; border-collapse:collapse;" bgcolor="#ffffff" cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr>
                      <td style="padding-left:24px; padding-right:24px; padding-bottom:24px;">
                        ...
                        <p>Congratulation! You've been invited to MYRE! Please complete registration by clicking the button below :</p>
                        
                        <div style="text-align:center; margin-top:24px; margin-bottom:24px;">
                          <a href="{{ $resetTokenLink }}" class="cta-button" style="display:inline-block; border-radius:2px; background-color:#17c89d; line-height:36px; color:#ffffff; text-decoration:none; padding-left:24px; padding-right:24px;">Set my password </a>
                        </div>
                        
                        <p>If the button does not work, we invite you to copy and paste the following address into your browser: <a href="http://myre.fr/resetlink" style="color:#0f376e;">http://myre.fr/resetlink</a></p>
